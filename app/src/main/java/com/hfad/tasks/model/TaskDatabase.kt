...
//5) Помечаем класс с помощью @Database, которая сообщает Room, что он определяет базу данных.
@Database(entities = [Task::class], version = 1, exportSchema = false)
//Класс TaskDatabase должен расширять RoomDatabase
abstract class TaskDatabase : RoomDatabase() {
    /*6) Указываю любые интерфейсы (помеченные @Dao), которые будут использоваться для доступа к данным.
   ...
   /*7)Создаем и везвращаем экземпляр базы данных - database
